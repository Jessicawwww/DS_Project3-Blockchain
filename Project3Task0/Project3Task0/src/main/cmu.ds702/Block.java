...
public class Block {
    ...
    private BigInteger nonce;  // this takes too long...
//    private int nonce;
...
//        this.nonce = 0;
    ...
    public String calculateHash() throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        //String message = previousHash + Long.toString(timestamp.getTime()) + nonce + data;
        //String message = index + previousHash + Long.toString(timestamp.getTime()) + nonce + data + difficulty;
